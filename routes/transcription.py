...
def transcribe():
    ...
    try:
        ...
        if 'webhook' in data:
            ...
            webhook_response = requests.post(data['webhook'], json=result)
            ...
            # If no webhook is provided, return the result directly
            logger.info("Transcription completed. Returning results directly.")
            return jsonify({
